package com.app.interfaces.Services.carpet;

import com.app.enums.City;
import com.app.interfaces.carpetPrices.Carpet;
...
public class carpetTX implements Carpet {
    ...
    static{
        ...
        sqPriceForCity.put(City.DALLAS, new BigDecimal("2.92"));
        sqPriceForCity.put(City.SAN_ANTONIO, new BigDecimal("4.65"));
